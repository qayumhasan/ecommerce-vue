    ...
    <section id="log_page">
        <div class="container">
            <div class="login_box_wrapper">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form class="login" method="POST" action="{{ route('admin.forgetpassword.change') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <span class="fas fa-lock"></span><input type="password" name="password_confirmation" id="password"  class="form-control" placeholder="Confirm Password">
                            </div>
                            <input type="submit" class="submit" value="Change Password"></input>
