...
@section('title', 'Order | '.$seo->meta_title)
                                      ...
                                      @foreach($allorder as $key => $data)
                                          ...
                                          <!-- <td>
                                              <label class="switch">
		                                       ...
		                                       <td>
		                                          <a  href="{{url('admin/product/order/invoice/'.$data->id)}}" class="btn btn-default btn-sm text-white" data-toggle="tooltip" data-placement="right" title="invoice" data-original-title="invoice"><i class="far fa-eye"></i></a>
