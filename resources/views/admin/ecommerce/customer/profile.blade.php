...
@section('title', 'Customer Profile | '.$seo->meta_title)
                        ...
                        <div class="user_profile_box">
                            <div class="user_profile text-center">
                                <div class="user_image">
                                    <img src="{{asset('public/uploads/customer/'.$profile->avatar)}}" alt="no-image" />
                                </div>
                                <h4>{{$profile->name}}</h4>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="tr">{{$profile->name}}</td>
                                    </tr>
                                    <tr>
                                        <td class="tl">Phone</td>
                                        <td class="tr">{{$profile->phone}}</td>
                                    </tr>
                                    <tr>
                                        <td class="tl">Email</td>
                                        <td class="tr">{{$profile->email}}</td>
                                    </tr>
                                    <tr>
                                        <td class="tl">Address</td>
                                        <td class="tr">{{$profile->address}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                ...
                                <div class="profile_update">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{url('admin/customeradmin/update')}}" method="post" enctype="multipart/form-data">
                                              @csrf
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label for="formGroupExampleInput">Name</label>
                                                        <input name="name" type="text" class="form-control" placeholder="name" value="{{$profile->name}}"/>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input name="email" type="email" class="form-control" placeholder="Email" value="{{$profile->email}}" />
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="formGroupExampleInput">Phone</label>
                                                        <input name="phone" type="text" class="form-control" placeholder="Phone" value="{{$profile->phone}}" disabled/>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="up_image">
                                                            <img src="{{asset('public/uploads/customer/'.$profile->avatar)}}" alt="no-iamge" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
