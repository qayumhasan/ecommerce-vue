...
@section('title', 'wallet Stripe | '.$seo->meta_title)
@section('content')
    ...
    <div class="container">
        ...
        <div class="sripe_payment">
            ...
            <div class="payment-form">
                ...
                <form action="{{ route('wallet.recharge.insert', $invoice_no) }}" class="stripe_form" method="POST" id="payment-form">
                    @csrf
                    ...
                    <div class="hidden_field">
                        ...
                        <input type="hidden" name="paid_time" value="{{ $time }}">
                        <input type="hidden" name="order_id" value="{{ $invoice_no }}">
                    </div>
                    <button class="btn btn-sm btn-success payment-button" type="submit" style="background-color: #fffe01;color:#000; font-size: 2.875rem;">Pay ({{ $amount }})</button>
                </form>
            </div>
        </div>
    </div>
