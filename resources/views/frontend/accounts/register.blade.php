                             ...
                             <div class="login-modal-right">
                                ...
                                <div class="tab-content">
                                   <div class="tab-pane active" id="login" role="tabpanel">
                                      <h5 class="heading-design-h5">Registration your account</h5>
                                      <fieldset class="form-group">
                                         <label>Mobile Number</label>
                                         <input type="text" name="phone_email" class="form-control" placeholder="Mobile">
                                          @error('phone_email')
                                      ...
                                      <fieldset class="form-group">
                                         <button type="submit" class="btn btn-lg btn-secondary btn-block">Registration</button>
                                      </fieldset>
                                ...
                                <div class="text-center login-footer-tab">
                                   <ul class="nav nav-tabs" role="tablist">
                                      ...
                                      <!--<li class="nav-item">-->
                                      <!--   <a class="nav-link"  href="{{url('customar/login')}}" ><i-->
                                      <!--         class="mdi mdi-pencil"></i> SignIn</a>-->
                                      <!--</li>-->
                                   </ul>
                                </div>
                                <div class="clearfix"></div>
