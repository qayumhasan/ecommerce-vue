                                   ...
                                   <tbody>
                                     @foreach(App\OrderFinal::where('user_id',Auth::user()->id)->latest()->paginate(5)  as  $key => $data)
                                      <tr>
                                         ...
                                         <td><a data-toggle="tooltip" data-placement="top" title="" href="{{route('customar.invoice.show.details',$data->id)}}" data-original-title="View Detail" class="btn btn-info btn-sm"><i class="mdi mdi-eye"></i></a></td>
                                      </tr>
                                    @endforeach
