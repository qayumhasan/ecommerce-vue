...
@section('title', 'Mobile Verification | '.$seo->meta_title)
@section('content')
                 ...
                 <div class="login-modal">
                    <div class="row">
                       ...
                       <div class="col-lg-6 pad-left-0">
                          ...
                          <form action="{{route('customar.forgot.mobile.verify')}}" method="post">
                            @csrf
                             <div class="login-modal-right">
                                <!-- Tab panes -->
                                <div class="tab-content">
                                   <div class="tab-pane active" id="login" role="tabpanel">
                                      <h5 class="heading-design-h5">Verify Your Account(Phone)</h5>
