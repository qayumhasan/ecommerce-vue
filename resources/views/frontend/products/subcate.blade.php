...
@section('title', $subcate->subcate_name. " | ".$seo->meta_title)
@section('content')
...
<section class="pt-3 pb-3 page-info section-padding border-bottom bg-white">
     <div class="container">
        <div class="row">
           <div class="col-md-12">
              <a href="{{url('/')}}"><strong><span class="mdi mdi-home"></span> Home</strong></a> <span class="mdi mdi-chevron-right"></span> <a href="">{{$subcate->subcate_name}}</a>
           </div>
        </div>
     </div>
  </section>
          ...
          <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
             <div class="card-body card-shop-filters">
              <div class="custom-control custom-checkbox">
               ...
               <label class="custom-control-label" for="1">৳68 to ৳659</label>
              </div>
              <div class="custom-control custom-checkbox">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
             <div class="card-body card-shop-filters">
              ...
              @foreach($allbrand as $key => $brand)
                 ...
                 @endphp
                   @php
                  $bproductlol=App\Product::where('brand',$brand->id)->first();
                @endphp
                               ...
                               @if(count($flashdealdetail) > 0)
                                  @foreach($flashdealdetail as $row)
                                     ...
                                     @if($row ->discount_type == 1 )
                                         ...
                                         <i class="mdi mdi-tag-outline"></i><br><span class="regular-price">৳ {{$product->product_price}}</span>
                                     @elseif($row ->discount_type == 2)
