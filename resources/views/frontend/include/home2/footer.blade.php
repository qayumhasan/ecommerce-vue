       ...
       <div class="container">
          <div class="row">
             <div class="col-lg-3 col-md-3">
                <h4 class="mb-5 mt-0"><a class="logo" href="{{url('/')}}"><img src="{{asset('/'.$logos->front_logo)}}" alt=""></a></h4>
                <p class="mb-0"><a class="text-dark" href="#" style="font-size:13px"><i class="mdi mdi-phone"></i> {{$continfor->phone_one}}</a></p>
                <p class="mb-0"><a class="text-dark" href="#" style="font-size:13px"><i class="mdi mdi-cellphone-iphone"></i> {{$continfor->phone_two}}</a></p>
          ...
          <div class="row no-gutters">
             <div class="col-lg-6 col-sm-6">
                <p class="mt-1 mb-0">&copy; Copyright 2020 <strong class="text-dark">{{$continfor->company_name}}</strong>. All Rights Reserved<br>
                    <small class="mt-0 mb-0">Made by <i class="mdi mdi-heart text-danger"></i> by <a href="www.durbarit.com" target="_blank" class="text-primary">Durbarit</a>
                </small>
        </p>
             </div>
